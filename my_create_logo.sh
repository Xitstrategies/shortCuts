...
# Gather Variables
 ...
 echo "Please provide the path and name of the zipped folder. If your path has spaces, this script has already changed the spaces to underscores. Here is a current directory listing:"
ls -lah
echo
 read philfile
 echo
...
rm $philfile;
lessc ~/WebstormProjects/syrinx/desktop/www/js_app/css_app/themes.less ~/WebstormProjects/syrinx/desktop/www/js_app/css_app/themes.css;
 echo
 echo
